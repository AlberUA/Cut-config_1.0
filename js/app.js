(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".our-blog__slider")) new swiper_core_Swiper(".our-blog__slider", {
            modules: [ Navigation, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
    ...
    window.onload = function() {
        const inputTel = document.querySelector("#formPhone");
        ...
        const inputTelPopup = document.querySelector("#formPhonePopup");
        ...
        const materials = document.querySelectorAll(".materials__item");
